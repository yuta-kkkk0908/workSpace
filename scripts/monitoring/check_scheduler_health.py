...
LOG_DIR = ROOT / "logs"
RUNTIME_PROMPTS_DIR = ROOT / "tmp" / "prompts"
DATA_DIR = ROOT / "data"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-json", default=str((RUNTIME_PROMPTS_DIR / "scheduler-health.json").relative_to(ROOT)))
    p.add_argument("--out-status", default=str((RUNTIME_PROMPTS_DIR / "scheduler-health.status.txt").relative_to(ROOT)))
